...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT, KC_Z, KC_X,        KC_C,    KC_V,    KC_B,   KC_MUTE,           KC_NO,   KC_N,   KC_M,    KC_COMM, KC_DOT,     KC_SLSH, KC_RSFT,   \
                 OSL(_RAISE), KC_LCTL, KC_LALT, KC_ENT, KC_LGUI,           KC_RGUI, KC_SPC, KC_RALT, KC_RCTL, OSL(_LOWER) \
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT( \
  ...
  KC_TRNS, KC_NO, TO(_ADJUST), KC_NO,   KC_NO,   KC_NO,   KC_TRNS,        KC_TRNS, KC_NO,     KC_APP,  KC_PGDOWN, KC_NO,   KC_NO,  KC_TRNS,    \
                  KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,        KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
